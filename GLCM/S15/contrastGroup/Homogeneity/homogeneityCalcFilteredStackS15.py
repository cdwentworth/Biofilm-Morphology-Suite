...
History:
    7.14.2020.1: base
    7.15.2020.1: modified for measurements of S15 stack
...
# User specified data
tiffStackFile = 'Processed_033018_W1FITC 100- CAM_S15_T_0.5 dyne_cm2.tif'  # This file should be in the same folder as prrogram
numSkippedFrames = 8
...
xHeader1 = 'GLCM Homogeneity S15 x\n'
...
yHeader1 = 'GLCM Homogeneity S15 y\n'
